...
CREATE TABLE `tb_member` (
  ...
  `remark` varchar(150) default NULL COMMENT '备注',
  `addDate` date default NULL COMMENT '加入时间',
  `lastBackPiecesDate` date default NULL COMMENT '最近退件时间',
  `lastLoginDate` date default NULL COMMENT '最近登录时间',
